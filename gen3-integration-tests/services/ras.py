...
class RAS(object):
    ...
    def get_tokens(
        ...
        payload = f"grant_type=authorization_code&code={auth_code}&client_id={client_id}&client_secret={client_secret}&scope=openid redirect&redirect_uri={pytest.root_url}"
