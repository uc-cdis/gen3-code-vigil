...
class TestDataUpload:
    ...
    def test_file_upload_and_download_via_api(self):
        ...
        try:
            ...
            file_node = {
                "did": file_guid,
                "data": {"md5sum": file_md5, "file_size": file_size},
            }
            ...
            sheepdog_res = nodes.submit_graph_and_file_metadata(
                sheepdog, file_guid, file_size, file_md5, validate_node=False
            )
            assert (
                sheepdog_res["addRes"]["code"] == 400
            ...
            sheepdog_res = nodes.submit_graph_and_file_metadata(
                sheepdog, file_guid, file_size, file_md5
            )
    ...
    def test_data_file_deletion(self):
        ...
        try:
            ...
            assert (
                sheepdog_res["addRes"]["code"] == 400
            ), f"Metadata linking should not be possible after file deletion"
    ...
    def test_upload_the_same_file_twice(self):
        ...
        try:
            ...
            nodes.submit_graph_and_file_metadata(
                sheepdog,
                file_guid,
                file_size,
                file_md5,
