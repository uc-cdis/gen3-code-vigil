        ...
        "manifest.json": json.dumps(
            {
                ...
                "versions": {
                    ...
                    "_audit-service": "707767160287.dkr.ecr.us-east-1.amazonaws.com/gen3/audit-service:feat_sai_removegino",
                    "audit-service": "707767160287.dkr.ecr.us-east-1.amazonaws.com/gen3/audit-service:master",
                ...
                "indexd": {"arborist": "true"},
                "jupyterhub": {"enabled": "no"},
                "peregrine": {"sidecar": "True"},
                "ssjdispatcher": {
                    "job_images": {
                ...
                "guppy": {
                    "indices": [
                        {"index": "midrc_case", "type": "case"},
                        {"index": "midrc_measurement", "type": "measurement"},
                        {"index": "midrc_annotation", "type": "annotation"},
                        {"index": "midrc_data_file", "type": "data_file"},
                        {"index": "midrc_imaging_study", "type": "imaging_study"},
                    ],
